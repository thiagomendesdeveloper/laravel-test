...
<div class="section-form-title">
    ...
    <p>cadastre anuncios de seus hoteis</p>
    ...
    <div class="container">
        <div class="section-form-content">
            ...
            <div class="section-form-inputs">
                <form method="POST" action="{{ Route('entrar') }}" class="section-form__form">
                    @csrf
                    <h3>Nome</h3>
                    ...
                    <a class="section-form-inputs__a" href="{{ Route('cadastrar') }}">Não possuo uma conta</a><br>
                    <a class="section-form-inputs__a" href="#">Esqueci minha senha</a>
                </form>
            </div>
        </div>
    </div>
